...
public @interface EitherTeamOrProject {
    ...
    Class<?>[] groups() default {}; // when you need to do some modification in this like you need pass on create
                                    // but not update you can specify the group name in the requestDTO.
